...
(function (exports) {
    ...
    module.exports = Task = Model.derive({
        ...
        self: {
            ...
            clearAsync: function () {
                ...
                // calls clearAsync without needing too, we should fie the
         ...
         * @param actions {function|array[function]} additional actions for
         *      this task
         * @returns {object} Task
         */
        enhance: function (deps, actions) {
            ...
            // splice new prerequisites and actions onto our original arrays
            // to keep the references intact.
            deps.forEach(function (d) {
                this.splice(this.length, 0, d);
            }, this.prerequisites);
    ...
    // Late require to avoid Task from being undefined when needed.
