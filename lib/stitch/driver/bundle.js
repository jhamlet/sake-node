...
(function (exports) {
    ...
    exports.Driver = BundleDriver = Proteus.create(Driver, {
        ...
        add:     util.aliasMethod("file", BundleDriver),
        include: util.aliasMethod("file", BundleDriver),
        inc:     util.aliasMethod("file", BundleDriver),
         ...
         * @param url {string} uri to fetch from
         * @returns {BundleDriver}
         */
        ...
        filter: function (type, name, phase, fn) {
            ...
            BundleDriver.context.addFilter(f);
            return BundleDriver;
        }
