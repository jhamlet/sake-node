...
(function (exports) {
    ...
    Object.defineProperties(Driver, {
        ...
        context: {
            get: function () {
                console.log("get Context: " + this.__context__);
            ...
            set: function (c) {
                ...
                console.log("set context from " + ctx + " to " + c);
        ...
        run: {
            value: function (fn, ctx) {
                ...
                tmpStitch = global.stitch ? 
                    util.swapInterface(global.stitch, this) :
                    false;
                ...
                tmpStitch = tmpStitch && util.swapInterface(global.stitch, tmpStitch);
    ...
    Driver.beforeContextChanged = function (ctx, c) {
        console.log(
            "Changing context from " + ctx +
            " to " + c);
    };
