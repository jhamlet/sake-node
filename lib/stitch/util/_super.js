...
(function (exports) {
     ...
     * 
     * NOTE: this function depends on ECMAScript 5 features of JavaScript, and
     * you have to invoke it with the correct 'this' context.
     * 
     ...
     * 
     *      someclass.prototype.foo = function (arg) { return this._super(arg);
     *      },
     * 
     *  Or, you can call it directly from within any object hierarchy:
     * 
     *      var objA = Object.create({}); objA.foo = function foo (arg) { ...  }
     * 
     *      var objB = Object.create(objA); objB.foo = function foo (arg) {
     *          return exports._super.call(this, arg);
     *      }
     * 
     * Ultimately, directly calling the next object in the chain would be more
     * performant (i.e: inside objB.foo: objA.foo.call(this, arg)), and this
