...
(function (exports) {
     ...
     * name as the one that was called, and call it in the correct scope (the
     * current 'this' object where '_super' is called).
     * 
     * This works for getters and setters in ES5, as well as getting
     * overridden plain propterties further up the prototype chain. i.e: if
     * you have objA with a plain property of 'foo' as a number, and objB,
     * with its prototype linked to objA, has a getter, or function, named
     * 'foo', calling '_super' will return the number.
     * 
     * Useage:
     * 
    ...
    exports._super = function _super () {
         ...
         * 
         * See if the function has been named, or if we've been down this route
         * before and applied our own label to the function (since we can not
         * modify the 'name' property of a function)
         * 
         * if not, we have to loop over our the 'this' object's top-level
