...
(function () {
    ...
    function resolveExcludes () {
        ...
        util.splice(items, 0, items.length, items.filter(function (path) {
    ...
    module.exports = FileList = Proteus.Class.derive({
        ...
        exclude: function () {
            ...
            util.splice(exPats, util.slice(arguments));
        ...
        clearExcludes: function () {
            var excludes = this.__exPats__;
            util.slice(excludes, 0, excludes.length);
        ...
        resolve: function () {
            ...
            if (this.__pending__) {
                ...
                util.splice(pendAdd, 0, pendAdd.length);
                resolveExcludes.call(this);
            }
            return this;
        },
        ...
        grep: function (pattern) {
            var isFn = util.isFunction(pattern),
                isRe = util.isRegExp(pattern),
                isGlob = !isFn && !isRe && pattern.match(/[*?]/)
            ;
        ...
        clone: function () {
            ...
            util.splice(dup.__pendingAdd__, this.__pendingAdd__);
            util.splice(dup.__items__, this.__items__);
            util.splice(dup.__exPats__, this.__exPats__);
            
            return dup;
        },
        
        dup: util.aliasMethod("clone"),
    ...
    (function () {
        ...
        function wrapMaker (name) {
            return function () {
                ...
                util.splice(items, 0, items.length,
