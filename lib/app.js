...
(function () {
    ...
    module.exports = App = {
        ...
        setupCommands: function () {
            ...
            // opts.command("foo").
            //     description(FS.readFileSync("Lorem.txt", "utf8")).
            //     action(util.noop);
        ...
        parseOptions: function (args) {
            ...
            this.options.on("list-tasks", this.listTasks.bind(this));
        ...
        run: function (fn) {
            ...
            // this.setupCommands();
            args = this.processEnvArgs(util.slice(process.argv, 2));
            args = [process.argv[0], process.argv[1]].concat(args);
            console.log(args);
