...
(function (exports) {
    ...
    function synthesizeFileTask (filepath) {
        ...
        return !this.initializing && Path.existsSync(filepath) ?
                new FileTask(filepath) :
                null;
    }
    //------------------------------------------------------------------------
    // INSTANCE PRIVATES
    ...
    function resolvePrerequisites () {
        if (this.__pending__) {
            this.__pendingPrereqs__.forEach(function (p) {
                if (p instanceof FileList || isArray(p)) {
    ...
    module.exports = Task = Model.derive({
        ...
        self: {
            ...
            derive: function (props) {
                ...
                Proteus.extend(Ctor, this);
                
                Ctor.prototype = Proteus.create(this.prototype);
             ...
             */
            get: function (id) {
                return this.lookup(id) || synthesizeFileTask.call(this, id);
            },
            ...
            has: function (id) {
                return Boolean(Model.get(id) || this.find({name: id})[0]);
            },
